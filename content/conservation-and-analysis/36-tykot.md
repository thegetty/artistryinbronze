...
By the Viking Age, both bronze and brass were widely used. Nondestructive analyses using a pXRF were conducted in the Stavanger Museum, Norway, to test for any patterns and provide information for the museum’s catalog and display. Among the nearly thirty copper-based objects tested, a cruciform brooch copy stands out as a typical bronze with only tin (9.4%) intentionally added ([fig. 36.4](fig. 36.4)). All other items tested were brass, with zinc ranging from just a few percent to more than twenty, and more than half also had tin and/or lead **(table 36.1**). The range among the percentages for each of these three elements also supports the likelihood of recycling rather than primary production of brass objects.
