...
Open shapes are predominant. Among them we find the *phialai mesomphaloi*—the drinking vessels and the libation vases *par excellence*—both in the “plain” and in the “lotus-bowl” versions together with large, deep bowls ([fig. 25.3](fig. 25.3)). Kantharoi, kylikes and other handled cups, skyphoi, and mugs are far less attested, while handles are the only surviving parts of paterae.
